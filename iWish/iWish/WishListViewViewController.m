...
{
    WishTableCell *cell = (WishTableCell*)[tableView dequeueReusableCellWithIdentifier:@"WishTableCell"];
    cell.CellData = [self.WishListArray objectAtIndex:indexPath.row];
    return cell;
}
